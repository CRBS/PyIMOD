...
def writeView(imodModel, iView, fid):
    ...
    fid.write(struct.pack('>f', imodModel.Views[iView].clips_point_x))
    fid.write(struct.pack('>f', imodModel.Views[iView].clips_point_y))
    fid.write(struct.pack('>f', imodModel.Views[iView].clips_point_z))
